    ...
    >
      <div className='max-w-7xl mx-auto lg:grid lg:grid-cols-2 lg:w-full lg:max-w-full'>
        ...
        <div className='lg:flex lg:flex-col lg:justify-center'>
          {/* TITLE */}
          <div className='text-center mt-10 lg:m-0'>
            <h1 className='h3'>
              I'm{' '}
          ...
          {/* SOCIAL ICONS */}
          <div className='align-horizontal justify-between w-2/3 max-w-sm mx-auto mt-6 text-lightest text-xl md:text-2xl lg:text-3xl'>
