  ...
  return (
    <section id="projects" className="bg-darkest py-14 lg:py-20">
      <div className="center max-w-7xl">
        {/* TITLE */}
        <h2 data-aos="fade-right" className="h2 uppercase mb-8 lg:mb-16">
        ...
        <Masonry
          ...
          spacing={2}
          className="max-w-[716px] xl:max-w-4xl 2xl:max-w-6xl mx-auto"
        >
          {projects.map(
            ({
              title,
              ...
              >
                <figure
                  key={title}
                  // set the the max width to sustain the cover image
                  className="bg-lightest rounded shadow max-w-[350px] mx-auto"
                >
                  {/* IMAGE */}
                  ...
                  <div className="text-center p-4 grid gap-y-4">
                    ...
                    <div className="flex gap-x-4 justify-center">
                      <a
                        ...
                        title="Preview"
                        target="_blank"
                        className="border border-darkest text-darkest rounded px-[1em] py-[.5em] capitalize hover:bg-darkest hover:text-lightest transition duration-500"
                      >
                        live demo
                      </a>
                      <a
                        ...
                        title="View Code"
                        target="_blank"
                        className="bg-darkest border border-darkest text-lightest  rounded px-[1em] py-[.5em] capitalize  hover:bg-dark hover:text-lightest transition duration-500"
                      >
                        source code
                      </a>
                    </div>
...
// {/* <div data-aos="fade-up" data-aos-anchor-placement="top" key={title}>
...
//           title="Preview"
//           target="_blank"
//           className="border border-darkest rounded px-[1em] py-[.5em] capitalize hover:bg-darkest hover:text-lightest transition duration-500"
//         >
//           live demo
//         </a>
//         <a
